...
`( 014 | ~( 0b0101 >> ( rand() & 0x3 ) ) ) - -0xf,b : 0b00001101`
...
Line number is the line where the first instruction in a function is defined. The function breakpoint representing this function below would be `constructor,script.nut:20`
